  ...
  return (
    <footer>
      <div className="first-footer-section">
        <div>
          <img alt="moneytree-logo" src="/assets/img/logo.png" />
          <address>
          ...
          <div className="footer-icons">
            <a
              ...
              href="https://www.facebook.com/moneytreerealty/ "
            >
              <svg
                fill="none"
                height={24}
            ...
            <a className="footer-icon" href="https://x.com/MoneytreeRSPL">
              <svg
                fill="none"
                height={24}
                viewBox="0 0 15 12"
            ...
            <a
              className="footer-icon"
              href="https://www.youtube.com/@Moneytreerealtyofficial"
            >
              <svg
        ...
        <div>
          <ul className="footer-nav-list">
            ...
            <li>
              <a href="/real-estate-consultant">Our Services</a>
            </li>
            <li>
      ...
      <div className="second-footer-section">
        <div>
          <p>© 2025, All rights reserved. Moneytree Realty Services Limited</p>
          <p>RERA Numbers:</p>
          <p>UP : UPRERAAGT25048</p>
          <p>Haryana : RC/HARERA/GGM/2569/2164/2024/282</p>
          <p>Maharashtra : A041172401062</p>
        </div>
        <div>
          <a
